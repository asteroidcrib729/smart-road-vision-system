        ...
        if category == "Motorcycle":
            ...
            for r in cursor.fetchall():
                records.append({
                    ...
                    "rawImage": f"/static/Restored_Dashboards/Plate_{r['Tracking_ID']}.jpg?t={cache_ts}",
                    "enhancedImage": f"/static/Restored_Dashboards/Restored_{r['Tracking_ID']}.jpg?t={cache_ts}",
                    "vehicleImage": f"/static/Motorcycles/{r['Tracking_ID']}.jpg?t={cache_ts}",
            ...
            for r in cursor.fetchall():
                records.append({
                    ...
                    "rawImage": f"/static/Restored_Dashboards/Plate_{r['Tracking_ID']}.jpg?t={cache_ts}",
                    "enhancedImage": f"/static/Restored_Dashboards/Restored_{r['Tracking_ID']}.jpg?t={cache_ts}",
                    "vehicleImage": f"/static/Auto_Rickshaws/{r['Tracking_ID']}.jpg?t={cache_ts}",
                    "plateNumber": r['Read_Number_Plate'] or "Missing/Obstructed",
            ...
            for r in cursor.fetchall():
                ...
                records.append({
                    ...
                    "rawImage": f"/static/Restored_Dashboards/Plate_{r['Tracking_ID']}.jpg?t={cache_ts}",
                    "enhancedImage": f"/static/Restored_Dashboards/Restored_{r['Tracking_ID']}.jpg?t={cache_ts}",
                    "vehicleImage": f"/static/Large_Vehicles/{r['Tracking_ID']}.jpg?t={cache_ts}",
                    "plateNumber": r['Read_Number_Plate'] or "Missing/Obstructed",
                    "ocrMethod": "Local OCR (PaddleOCR v4)",
                    "confidence": 94.5,
